		...
		<div>
			...
			<div className="row row-cols-2 g-4 mb-4">
				...
				<div className="card">
					...
					<a href="https://mchung03.github.io/weather-forecast-api/Links" target="_blank" className="card-link">Website</a>
					<a href="https://github.com/mchung03/weather-forecast-api.gitLinks" target="_blank" className="card-link">GitHub</a>
					</div>
				</div>
				</div>
			</div>
